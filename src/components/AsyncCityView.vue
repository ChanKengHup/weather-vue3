  ...
  <div class="flex flex-col flex-1 items-center">
    ...
    <div class="flex flex-col items-center text-white py-12">
      ...
      <p class="text-8xl mb-8">
        {{ handleDisplayTemp(weatherData.current.temp) }}&deg;C
      </p>
      <p class="capitalize">
        ...
        <div class="flex gap-10 overflow-x-scroll">
          ...
          >
            ...
            <img
              ...
              alt=""
            />
            <p class="text-xl">{{ handleDisplayTemp(hourData.temp) }}&deg;C</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="mx-8 text-white">
        ...
        >
          ...
          <div class="flex gap-2 flex-1 justify-end">
            <p>H: {{ handleDisplayTemp(day.temp.max) }}</p>
            <p>L: {{ handleDisplayTemp(day.temp.min) }}</p>
          </div>
        </div>
      </div>
    </div>
